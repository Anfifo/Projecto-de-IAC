...
posicao_seguinte_comboio0:
  WORD NENHUM_SENSOR
posicao_actual_comboio0:
  WORD NENHUM_SENSOR
posicao_anterior_comboio0:
  WORD NENHUM_SENSOR                       
...
PUSH R9
  ...
  ocupar_o_troco_actual:
    MOV R7, OCUPADO
    MOV R0, R8                          ; colocar a localizacao do comboio no argumento R0 
    CALL alterar_o_troco
  desocupar_o_troco_anterior:
    MOV R7, DESOCUPADO                  ; o estado R7 entra como argumento na alteracao do troco 
    MOV R0, R9                          ; colocar a localizacao do comboio no argumento R0 
    CALL alterar_o_troco 
...
PUSH R9
  ...
  CMP R0, R9
    JZ fim_alterar_semaforo_correspondente
  CMP R7, OCUPADO
...
;interrupcao0:                 ;faz uma escrita num endereço do valor lido
;PUSH R1
;PUSH R2 
;PUSH R3
